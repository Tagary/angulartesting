...
export class CardComponent implements OnInit {
    ...
    ngOnInit() {
        setTimeout(() => {
            this.imgUrl = 'https://miro.medium.com/max/1200/1*pHsEux2h8wc3-yNCQNwz0A.jpeg'
            this.disabled = true
        }, 3000)
    }
